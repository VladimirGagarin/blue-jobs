...
export default function AboutContent() {
  ...
  const userId = user?.userId || "guest" 
   ...
   const applyjobLink = userId && userId !== "guest" ? `/job?type=get&userId=${userId}` : "/guest";
   const postjobLink = userId && userId !== "guest" ? `/job?type=post&userId=${userId}` : "/guest";
          ...
          <div className="motive-section">
              ...
              <div className="motive-footer" ref={ctaRef}>
                ...
                <div className="ctas-motive">
                      <button onClick={() => navigate(applyjobLink)}>{language === "fr" ? "Rechercher un emploi ?" : "Looking for a job ?"}</button>
                      <button onClick={() => navigate(postjobLink)}>{language === "fr" ? "Publier une offre" : "Post a job"}</button>
                  </div>
          )}
              </div>
          </div>
