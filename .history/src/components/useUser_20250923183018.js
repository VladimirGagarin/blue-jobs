...
export function browserCountryAbbreviations() {
  return [
  // Africa
    { abb: "KE", name: "Kenya", nationality: {en:"Kenyan", fr} },
    ...
    { abb: "CM", name: "Cameroon", nationality: "Cameroonian" },
    { abb: "ZA", name: "South Africa", nationality: "South African" },
    { abb: "DZ", name: "Algeria", nationality: "Algerian" },
    { abb: "MA", name: "Morocco", nationality: "Moroccan" },
    { abb: "TN", name: "Tunisia", nationality: "Tunisian" },
    { abb: "EG", name: "Egypt", nationality: "Egyptian" },
  // Europe
    { abb: "FR", name: "France", nationality: "French" },
    { abb: "BE", name: "Belgium", nationality: "Belgian" },
    { abb: "CH", name: "Switzerland", nationality: "Swiss" },
    { abb: "GB", name: "United Kingdom", nationality: "British" },
    { abb: "DE", name: "Germany", nationality: "German" },
    { abb: "IT", name: "Italy", nationality: "Italian" },
  ];
}
