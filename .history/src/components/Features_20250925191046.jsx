...
export default function FeatureContent() {
  ...
  const handleGetStarted = () => {
    if (userId && userId !== "guest") {
      // Logged in users go to job search
      navigate(`/job?type=get&userId=${userId}`);
    } else {
      // Guests go to guest page to sign up/login
      navigate("/guest");
    }
  };
  ...
  const handleBrowseJobs = () => {
        ...
        navigate("/jobs-public"); // Or wherever your public job listings are
        // Alternative: navigate("/?panel=jobs") if you have a public jobs panel
    };
      ...
      <section className="cta-section">
        ...
        {userId === "guest" && (
          <p className="guest-notice">
            {language === "fr"
              ? "👋 Invité ? Inscrivez-vous pour postuler aux offres et accéder à toutes les fonctionnalités !"
              : "👋 Guest? Sign up to apply for jobs and access all features!"}
          </p>
        )}
      </section>
    </div>
