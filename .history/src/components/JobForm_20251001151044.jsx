...
export default function JobForm({ language, onSubmitJob, userPostedJobs, userTokens }) {
  ...
  const translations = {
    en: {
      ...
      perYear: "Per Year",
      perDay: "Per Day",
      available: "available for posting jobs",
      insufficient: "remaining - get more tokens to post jobs",
    },
    fr: {
      ...
      descriptionPlaceholder:
        "Décrivez le rôle, les responsabilités et ce qui rend votre entreprise géniale...",
      ...
      available: "disponibles pour publier des emplois",
      insufficient:
        "restants - obtenez plus de jetons pour publier des emplois",
      youHave: "Vous avez",
      tokens: "jetons",
    ...
    sw: {
      ...
      descriptionPlaceholder:
        "Elezea jukumu, majukumu, na kile kinachofanya kampuni yako kuwa bora...",
      ...
      available: "zinapatikana kwa kuchapisha kazi",
      insufficient: "zilizobaki - pata tokeni zaidi ili uchapishe kazi",
      youHave: "Una",
      tokens: "tokeni",
