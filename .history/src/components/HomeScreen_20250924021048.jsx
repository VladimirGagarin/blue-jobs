   ...
   return(
       <div className="home-section">
           <div className="left-side-cta-content">
               <h1 className="title">{language === "fr" ? "" : "Find ,"}<span className="highlight">{fancyJobTerms[currentTermIndex]}</span>{language ==="fr" ? "" : " in "} {countries.find((c) => c.abb === userCountry)?.name || "Kenya"} </h1>
           </div>
