  ...
  <div className="blue-token-content">
    ...
    <div className="blue-token-message">
      ...
      <div className="blue-token-description">
        {t.youHave} <strong className="blue-token-highlight">{userTokens}</strong> {t.tokens.toLowerCase()} {userTokens > 0 ? t.available : t.insufficient}
      </div>
    </div>
  </div>
              ...
              <div className="blue-duration-options">
                {paymentDurations.map(duration => (
                  <button
                    key={duration.value}
                    type="button"
                    className={`blue-duration-option ${formData.jobPaymentDuration[duration.value] ? 'blue-active' : ''}`}
        ...
        <div className="blue-my-jobs-section">
          ...
          {userPostedJobs.length === 0 ? (
            <div className="blue-no-jobs">
              ...
              <p className="blue-no-jobs-message">Start by creating your first job posting!</p>
            </div>
          ) : (
              ...
              {userPostedJobs.map(job => (
                <div key={job.jobId} className="blue-job-item">
                  ...
                  <div className="blue-job-item-details">
                    ...
                    <span className="blue-job-detail-separator">•</span>
                    <span className="blue-job-applicants">{job.jobApplicants.length} {t.applicants}</span>
                  </div>
