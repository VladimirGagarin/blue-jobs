    ...
    <header className="blue-jobs-header">
      ...
      <div className="blue-header-right">
        ...
        <div className="blue-user-menu-container" ref={userMenuRef}>
          <button className="blue-user-avatar-btn" onClick={handleUserMenuToggle}>
            ...
            <div className="blue-user-info">
              ...
              <span className="blue-user-name">
                {user.userName || t.guest}
              </span>
            </div>
            <div className={`blue-menu-chevron ${showUserMenu ? 'blue-open' : ''}`}>
            ...
            <div className="blue-user-dropdown-menu">
              <div className="blue-menu-header">
                ...
                <div className="blue-menu-user-details">
                  <span className="blue-menu-user-name">{user.userName || t.guest}</span>
                  <span className="blue-menu-user-email">{user.userEmail || "No email"}</span>
                </div>
              </div>
