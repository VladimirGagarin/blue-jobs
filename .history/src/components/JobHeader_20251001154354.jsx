...
import { FaHome, FaUser, FaBell, FaCog, FaSignOutAlt, FaGem } from "react-icons/fa";
import { useState, useRef, useEffect } from "react";
import "./JobHeader.css";
import { useNavigate } from "react-router-dom";


export default function JobsHeader({ user, language, onNavigateHome, uchangeUser }) {
  ...
  const handleMenuItemClick = (action) => {
    ...
    const actions = {
      ...
      notifications: () => navigate("/?panel=notifications"),
      settings: () => navigate("/?panel=settings"),
      logout: () => {
        // Clear user data
        updateUser(null);
