...
import {useUserser } from "./useUser.js";
      ...
      <article>
        ...
        <p>
          ...
          <div className="ctas-motive">
                <button onClick={() => navigate()}>{language === "fr" ? "Rechercher un emploi" : "Looking for a job"}</button>
                <button>{language === "fr" ? "Publier une offre" : "Post a job"}</button>
              </div>
          </div>
      {/* Add more sections as needed */}
      <div className="about-footer">
        <p>&copy; 2024 Blue Jobs. {language === "fr" ? "Tous droits réservés." : "All rights reserved."}</p>
          </div>
    </div>
  );
}
