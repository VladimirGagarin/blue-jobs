...
export default function ReviewContent() {
  ...
  const reviewsWithUsers = reviews.map((review) => ({
    ...
    userCertified: review.userCertified || [],
    // Calculate helpfulCount from userCertified length
    helpfulCount: review.userCertified
      ? review.userCertified.length
      : review.helpfulCount || 0,
    // Check if current user has certified this review
    isCertifiedByUser: review.userCertified
    ...
    setReviews((prevReviews) =>
      prevReviews.map((review) => {
        if (review.reviewId === reviewId) {
          const currentCertified = review.userCertified || [];
          ...
          return {
            ...
            helpfulCount: updatedCertified.length,
  ...
  const editReview = (reviewId) => {
    ...
    if (reviewToEdit) {
      ...
      // You might want to set an editing state and show the form
      alert(
        language === "fr"
            ...
            <div className="review-footer">
              <div className="review-stats">
                ...
                {userId && userId !== review.reviewCreatorId && (
                  ...
                  >
                   {review.isCertifiedByUser ? <FaThumbsUp /> : <FaThumbsDown />}
