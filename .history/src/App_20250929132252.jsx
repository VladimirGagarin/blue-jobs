...
function App() {
  ...
  const contentPanels = {
    ...
    notifications: <NotificationComponentContent />,
    ...
    useEffect(() => {
      const panelName =
        panelDisplayNames[currentPanel]?.[language] ||
        panelDisplayNames[currentPanel]?.en ||
        "Blue Jobs";
      document.title = `${panelName} | Blue Jobs`;
    }, [currentPanel, language]);
