export const mockJobs = [
    ...
    jobSalary: {
        ...
        jobLocationObservedLandmarks: {
            church: {name:"St. Mary's Cathedral", position: {distance: {length:200, measurement: "Meters"},  compass: {north: true, south: false, east: false, west: false}}}, // position we use booleans of  near , opposite ,north , south , east , west and distance in meters or miles kilometers
            estate: {name:"Westlands", position: {distance: {length:300, measurement: "Meters"},  compass: {north: false, south: true, east: false, west: false}}},
            street: {name:"Kimathi Street", position: {distance: {length:150, measurement: "Meters"},  compass: {north: false, south: false, east: true, west: false}}},
            city: {name:"Nairobi", position: {distance: {length:500, measurement: "Meters"},  compass: {north: false, south: false, east: false, west: true}}},
            country: {name:"Kenya", position: {distance: {length:1000, measurement: "Kilometers"},  compass: {north: false, south: false, east: false, west: false}}},
            mosque: null,
            synagogue: null,
            temple: null,
            other: null,
