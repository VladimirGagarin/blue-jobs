...
export const mockUsers = [
  {
    ...
    userRole: "basic",
    userNotifications: [], // store notification ids
    userLikeJobs: [], // store job ids
    userBookmarkedJobs: [], // store job ids
  },
  {
    userId: "u12346",
  ...
  },
  {
    ...
    userId: "admin001",
    userName: "Admin User",
    userNationalId: "00000001",
    userEmail: "admin@email.com",
    userPhoneNumber: "+254700000001",
    userNationality: "Kenyan",
    userIsPremium: true,
    userJobPostPermit: true,
    userApplyPermit: true,
    ...
    userPostTokens: 10,
    userApplyTokens: 10,
    userDateCreated: "2025-09-01T00:00:00Z",
    userPassportPhoto: "https://bluejobs.com/uploads/admin001.jpg",
    userPassword: "Admin@2025",
    userRole: "admin",
  ...
  },
  {
    ...
    userApplyPermit: true,
    userPostedJobs: [],
    userAppliedJobs: ["aj_2025X"], // job ids
    userPostTokens: 2,
    userApplyTokens: 3,
    ...
    userRole: "basic",
    userNotifications: [], // store  notification id,
    userLikeJobs: [], // store job ids
    userBookmarkedJobs: [], // store job ids
  },
];
