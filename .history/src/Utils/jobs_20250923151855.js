export const mockJobs = [
    ...
    jobSalary: {
        ...
        jobLocationObservedLandmarks: {
            church: {name:"St. Mary's Cathedral", position: {distance: {length:200, measurement: "Meters"},  }}, // position we use booleans of  near , opposite ,north , south , east , west and distance in meters or miles kilometers
            estate: {"Westlands"},
