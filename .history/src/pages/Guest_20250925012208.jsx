    ...
    return (
        <div className="guest-page">
            <div className="guest-page-content">
                ...
                <button onClick={handleLogin} className="">{language === "fr" ? "Se connecter" : "Log In"}</button>
                <button onClick={handleSignup} className="">{language === "fr" ? "S'inscrire" : "Sign Up"}</button>
            </div>
            <Footer />
        </div>
    );
