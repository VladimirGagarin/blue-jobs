...
export default function OTP() {
  ...
  useEffect(() => {
    document.title =
      language === "fr"
        ? "Vérification OTP | Blue Jobs"
        : "OTP Verification | Blue Jobs";
  }, [language]);
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      const isValid = otpString === "123456"; // Default test code

      if (isValid) {
        setSuccess(true);
        // In real app, you would complete login process here
      } else {
        setError(t.invalidOtp);
      }
    } catch (err) {
        ...
        <div className="otp-container">
          <div className="otp-content">
            <div className="otp-success">
              ...
              <button className="success-button" onClick={handleGoToProfile}>
                {t.goToProfile}
              </button>
            </div>
          </div>
