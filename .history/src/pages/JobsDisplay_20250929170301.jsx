  ...
  const [availableJobs, setAvailableJobs] = useState([
    {
      ...
      jobStatus: "active",
      jobPaymentDuration: { year: false, month: false, week: true, day: false },
      jobSalary: {
        min: 800,
        max: 1200,
        currency: "USD",
    ...
    },
    {
      ...
      jobShift: "Day",
      jobDescription:
        "Join our dynamic marketing team to drive brand awareness and customer engagement across multiple channels.",
      jobRequirements: [
      ...
      jobStatus: "active",
      jobPaymentDuration: { year: false, month: true, week: false, day: false },
      jobSalary: {
        min: 120000,
        max: 180000,
        currency: "KES",
      ...
      jobLocationObservedLandmarks: {
        ...
        city: "Mombasa",
        country: "Kenya",
        market: "Mombasa Municipal Market",
