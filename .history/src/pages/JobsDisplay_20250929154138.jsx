...
export default function JobsDisplay() {
  ...
  const location = useLocation();
    ...
    const getTabTitle = () => {
        if (activeTab === "get") {
        return language === "fr" ? "Trouver des Emplois" : 
                language === "sw" ? "Tafuta Kazi" : "Find Jobs";
        } else {
        return language === "fr" ? "Publier des Emplois" : 
                language === "sw" ? "Tangaza Kazi" : "Post Jobs";
        }
    };

    const tabTitle = getTabTitle();
    document.title = `${tabTitle} | Jobs | Blue Jobs`;
    }, [activeTab, language]);

  // Translations
  const translations = {
    en: {
      pageTitle: `${activeTab === "get" ? "Find Jobs" : "Post Jobs"} | Jobs | Blue Jobs`,
      getJobs: "Find Jobs",
      postJobs: "Post Jobs",
    ...
    fr: {
      pageTitle: ` ${activeTab === "get" ? "Trouver des Emplois" : "Publier des Emplois"} | Emplois | Blue Jobs`,
    ...
    sw: {
      pageTitle: `${activeTab} | Kazi | Blue Jobs`,
      getJobs: "Tafuta Kazi",
