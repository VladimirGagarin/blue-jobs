...
export default function Login() {
  ...
  // Slideshow effect - Start automatic image rotation
  useEffect(() => {
    if (videoError) {
    ...
    // Cleanup function to clear interval when component unmounts or videoError changes
    return () => {
      if (slideshowInterval.current) {
        clearInterval(slideshowInterval.current);
      }
    };
  }, [videoError]); // Re-run when videoError changes
