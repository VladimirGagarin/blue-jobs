...
import { FaHome, FaEye, FaEyeSlash, FaUser, FaEnvelope, FaPhone, FaLock } from 'react-icons/fa';
import './Login.css';

// Sample background video (replace with your actual video)
const backgroundVideo = "https://assets.mixkit.co/videos/preview/mixkit-group-of-friends-having-a-party-4645-large.mp4";
// Fallback image if video doesn't load
const backgroundImage = "https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80";
...
export default function Login() {
    ...
    return (
        <div className="login-container">
            {/* Home Button */}
            <button className="home-button" onClick={handleGoHome} title={t.home}>
                <FaHome size={20} />
            </button>
