...
const backgroundVideo =
  "https://assets.mixkit.co/videos/preview/mixkit-group-of-friends-having-a-party-4645-large.mp4";
// Fallback image if video doesn't load
const backgroundImage =
  "https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80";
          ...
          >
            <div className="form-group">
              ...
              <input
                ...
                placeholder={
                  language === "fr" ? "exemple@email.com" : "example@email.com"
                }
                disabled={loading}
              />
            </div>
            ...
            <div className="form-group">
              ...
              <input
                ...
                className="form-input"
                placeholder={
                  language === "fr" ? "+33 1 23 45 67 89" : "+1 (555) 123-4567"
                }
                disabled={loading}
              />
            </div>
