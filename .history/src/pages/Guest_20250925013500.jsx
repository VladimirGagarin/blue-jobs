...
export default function GuestPage() {
    ...
    const cardsButtons = [
        { text: language === "fr" ? "Accueil" : "Home", onClick: () => navigate("/?panel=home"), photo:Home },
        { text: language === "fr" ? "Se connecter" : "Log In", onClick: handleLogin },
        { text: language === "fr" ? "S'inscrire" : "Sign Up", onClick: handleSignup },
    ];
