...
export default function ProfileContent() {
    ...
    useEffect(() => {
        ...
        if (savedLanguage === "fr" || savedLanguage === "en") {
            // Update the language state with the saved preference
        ...
        <div className="profile-card">
          <div className="profile-main">
            ...
            <div className="profile-sidebar">
              ...
              <div
                className={user.userIsPremium ? "premium-badge" : "basic-badge"}
              >
              ...
              <div className="stats-grid">
                ...
                <div className="stat-item">
                  ...
                  <span className="stat-number">
                    {Math.floor(
                      (new Date() - new Date(user.userDateCreated)) /
                        (1000 * 60 * 60 * 24)
                    )}
                  </span>
                  <span className="stat-label">
                ...
                <div className="info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <span className="info-value">
                      {formatDate(user.userDateCreated)}
                    </span>
                  </div>
                </div>
              </section>
                  ...
                  <div className="tokens-grid">
                    <div className="token-card">
                      ...
                      <div className="token-label">
                        {language === "fr"
                          ? "Jetons de Publication"
                          : "Post Tokens"}
                      </div>
                      <div
                        className={`token-status status-${
                          getTokenStatus(user.userPostTokens).status
                        }`}
                      >
                    ...
                    <div className="token-card">
                      ...
                      <div className="token-label">
                        {language === "fr"
                          ? "Jetons de Candidature"
                          : "Apply Tokens"}
                      </div>
                      <div
                        className={`token-status status-${
                          getTokenStatus(user.userApplyTokens).status
                        }`}
                      >
